...
# custom classes
from rl_agent.env_wrapper.youbot.ros_env_youbot import RosEnvYoubot
...
class RosEnvContYoubot(RosEnvYoubot):
    '''
    This class is a simulation environment wrapper for
    the X-Image Representation
    with continuous action space.
    '''
    def __init__(self, ns, state_collector, stack_offset, stack_size, robot_radius = 0.347, reward_fnc=6, debug=False, execution_mode="train", task_mode="static"):
