...
class StateCollector():
    ...
    def __init__(self, ns, train_mode):
        ...
        if ["train", "eval"].__contains__(self.__mode):
            ...
            self.static_scan_sub_ = rospy.Subscriber("%s/scan" % (self.__ns), LaserScan, self.__static_scan_callback,
                                                     queue_size=1)

            self.ped_scan_sub_ = rospy.Subscriber("%s/scan" % (self.__ns), LaserScan, self.__ped_scan_callback,
                                                  queue_size=1)
            ...
            self.static_scan_sub_ = rospy.Subscriber("%s/scan" % (self.__ns), LaserScan,
